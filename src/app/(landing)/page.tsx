...
import { BoldIcon, LockIcon, MountainIcon, RocketIcon, SparklesIcon } from "lucide-react";
...
export default async function Home() {
 ...
 <div key="1" className="flex flex-col min-h-[100dvh]">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-gray-100 dark:bg-gray-950" id="hero">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="container grid items-center justify-center space-y-8 px-4 md:px-6">
          <div className="space-y-2 text-center">
            ...
            <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
              Hear from the teams that love using our platform to build amazing web experiences.
            </p>
          </div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800" id="cta">
